...
const Adviser = () => {
  ...
  const handleAdviceRequest = async () => {
    try {
      ...
      setAdvice(content.response.Analysis);
          ...
          <div className="flex justify-between">
            <div className="p-4 shadow-xl shadow-blue-100 w-full flex">
              ...
              <button
                ...
                className="bg-blue-500 flex items-center text-center p-4 m-4 text-white rounded-full h-12 w-12  cursor-pointer"
              >
                <SendHorizonal />
              </button>
            </div>
